...
public class WithdrawCommand implements Command {
    ...
    public String execute(String[] arguments) {
        ...
        if (arguments == null || arguments.length == 0) {
            return "No arguments provided. Available arguments: " + WithdrawCommandArgument.getAllArguments();
        }

        WithdrawCommandArgument argument = WithdrawCommandArgument.fromString(arguments[0]);
        if (argument == null) {
            return "Unknown argument. Available arguments: " + WithdrawCommandArgument.getAllArguments();
        }
    ...
    private String withdrawMoney(String argument) {
        ...
        try {
            ...
            if (user.getBalance() < 0) {
                outputText = "Warning! You're balance will be negative! Money successfully deposited. Your new balance is: " + user.getBalance();
            } else {
                outputText = "Money successfully deposited. Your new balance is: " + user.getBalance();
            }
