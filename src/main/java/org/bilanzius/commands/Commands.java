...
import org.bilanzius.commands.implementations.bilanzius.BilanziusCommandArguments;
import org.bilanzius.commands.implementations.convert.ConvertCommandArguments;
import org.bilanzius.commands.implementations.createCategory.CreateCategoryCommandArguments;
import org.bilanzius.commands.implementations.deleteCategory.DeleteCategoryCommandArguments;
import org.bilanzius.commands.implementations.deposit.DepositCommandArguments;
import org.bilanzius.commands.implementations.getBankAccount.GetBankAccountCommandArguments;
import org.bilanzius.commands.implementations.getCategory.GetCategoryCommandArguments;
import org.bilanzius.commands.implementations.withdraw.WithdrawCommandArgument;
...
public enum Commands
{
    ...
    DEPOSIT("/deposit",
        Localization.getInstance().getMessage("deposit_short_description"),
        DepositCommandArguments.getAllArguments()),
    WITHDRAW("/withdraw",
        Localization.getInstance().getMessage("withdraw_short_description"),
    ...
    REPORT("/report",
        Localization.getInstance().getMessage("report_short_description"), null);
